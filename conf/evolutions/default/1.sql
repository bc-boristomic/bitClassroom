...
create sequence report_weekly_field_seq;

create sequence role_seq;

create sequence user_seq;

create sequence weekly_field_seq;
...
alter table report_weekly_field add constraint fk_report_weekly_field_weekly_10 foreign key (weekly_report) references weekly_report (id) on delete restrict on update restrict;
create index ix_report_weekly_field_weekly_10 on report_weekly_field (weekly_report);
alter table report_weekly_field add constraint fk_report_weekly_field_weekly_11 foreign key (weekly_field) references weekly_field (id) on delete restrict on update restrict;
create index ix_report_weekly_field_weekly_11 on report_weekly_field (weekly_field);
...
drop table if exists report_weekly_field;
...
drop table if exists weekly_field;
...
drop sequence if exists report_weekly_field_seq;

drop sequence if exists role_seq;

drop sequence if exists user_seq;

drop sequence if exists weekly_field_seq;
