...
public class Users {
    ...
    private static String[] passwordTeam = {"Medina123", "Nidal123", "Enver123", "Becir123",
            "Senadin123", "Boris123"};

    private static String[] firstNameTeachers = {"Benjamin", "Vedad", "Tarik", "Emir", "Elmedin",
            "Damir", "Zaid"};
    private static String[] lastNameTeachers = {"Talic", "Letic", "Celik", "Arnautovic", "Selmanovic",
            "Zekic", "Zerdo"};
    ...
    private static String[] emailStudents = {"adis.cehajic@bitcamp.ba", "adnan.lapendic@bitcamp.ba",
            "ajdin.brkic@bitcamp.ba", "ajla.eltabari@bitcamp.ba", "alen.bumbulovic@bitcamp.ba",
            "amra.sabic@bitcamp.ba"};

    private static String[] firstNameMentors = {"Nejra", "Nermin", "Mirza"};
    private static String[] lastNameMentors = {"Hodzic", "Sehic", "Mujanovic"};
    private static String[] emailMentors = {"nejra.hodzic@bitcamp.ba", "nermin.sehic@bitcamp.ba",
